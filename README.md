...
A frontend-only, production-structured dashboard application built with React, TypeScript, and Vite. The app includes authentication flow, protected routes, lazy-loaded pages, and MUI-based theming (light/dark mode) using a clean, feature-based architecture.
